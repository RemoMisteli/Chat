...
public class UserServiceTests {
	...
	public void init() {
		...
		listFull.add(messages);
		fullEntity.setSendedMessages(listFull);
		...
		listWithSendedMessages.add(sendedMessages);
		EntityWithNoRecivedMesage.setSendedMessages(listWithSendedMessages);
